...
\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\linewidth]{ss/Gemini_Generated_Image_eddt1eeddt1eeddt.png}
\caption{LaunchMind Multi-Agent System Architecture showing the hierarchical orchestration and communication layers.}
\label{fig:arch}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\linewidth]{ss/sequence_academic.png}
\caption{Autonomous Coordination Sequence: This diagram illustrates the inter-agent dialogue and task-handover protocol mediated by the Message Bus.}
\label{fig:sequence}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\linewidth]{ss/comparison_academic.png}
\caption{Efficiency Analysis: A comparison between traditional manual startup launch workflows and the autonomous LaunchMind MAS execution time.}
